            ...
            <div class="col-md-8">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-warning text-dark text-center py-3">
                        <h4 class="mb-0 fw-bold">✏️ แก้ไขข้อมูลลูกค้า</h4>
                    </div>
                    <div class="card-body p-4">
                        ...
                        // --- 1. ตรวจสอบการกดบันทึกข้อมูล (POST) ---
                        ...
                        // --- 2. ดึงข้อมูลเดิมมาแสดงในฟอร์ม (GET) ---
                        if (isset($_GET['CustomerID'])) {
                            ...
                            // ดึงรายชื่อประเทศมาแสดงใน Dropdown
                            ...
                            <form action="updatecustomer.php" method="POST">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control bg-light text-muted" name="customerID" value="<?= htmlspecialchars($customer['CustomerID']) ?>" readonly>
                                        <small class="text-danger">* ไม่สามารถแก้ไขรหัสได้</small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label fw-bold">เลือกประเทศ (พิมพ์ค้นหาได้)</label>
                                        <select class="form-select select2-search" name="countryCode" required>
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-2">
                                    <a href="index.php" class="btn btn-secondary btn-lg px-4">ยกเลิก</a>
                                    <button type="submit" class="btn btn-warning btn-lg px-4 fw-bold">บันทึกการแก้ไข</button>
                                </div>
                            </form>

                        <?php
                        } else {
                            echo "<div class='alert alert-danger text-center'>กรุณาเลือกลูกค้าที่ต้องการแก้ไขจากหน้าแรก</div>";
                        }
                        ?>
